 ...
 *
 * It uses an array_based_order_book.
 */
...
public:
  ...
  jb::config_attribute<config, int> array_max_size;
};
...
int main(int argc, char* argv[]) try {
  ...
  // set array_based_order_book max_size value
  //  jb::itch5::order_book<jb::itch5::array_based_order_book>
  //  ::max_size(cfg.array_max_size());
  ...
  jb::itch5::compute_book<order_book_t> handler(cb);
