#ifndef jb_pitch2_order_executed_price_message_hpp
#define jb_pitch2_order_executed_price_message_hpp
...
/**
 * Represent the 'Order Executed at Price/Size' message in the PITCH-2.X
 * protocol.
 *
...
struct order_executed_price_message {
  ...
  constexpr static int type = 0x24;
...
#endif // jb_pitch2_order_executed_price_message_hpp
