...
BOOST_AUTO_TEST_CASE(fftw_cast_array_3d_double) {
  ...
  check_cast_array_3d<jb::fftw::aligned_multi_array<double, 3> const, double const*>();
}

/**
 * @test Verify that fftw_cast functions work for boost::multi_array<long double>
 */
BOOST_AUTO_TEST_CASE(fftw_cast_array_3d_long_double) {
  check_cast_array_3d<boost::multi_array<long double, 3>, long double*>();
  check_cast_array_3d<boost::multi_array<long double, 3> const, long double const*>();

  check_cast_array_3d<jb::fftw::aligned_multi_array<long double, 3>, long double*>();
  check_cast_array_3d<jb::fftw::aligned_multi_array<long double, 3> const, long double const*>();
}
...
BOOST_AUTO_TEST_CASE(fftw_cast_array_3d_complex_float) {
  check_cast_array_3d<boost::multi_array<std::complex<float>, 3>, fftwf_complex*>();
  check_cast_array_3d<boost::multi_array<std::complex<float>, 3> const, fftwf_complex const*>();

  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<float>, 3>, fftwf_complex*>();
  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<float>, 3> const, fftwf_complex const*>();
}
...
BOOST_AUTO_TEST_CASE(fftw_cast_array_3d_complex_double) {
  check_cast_array_3d<boost::multi_array<std::complex<double>, 3>, fftw_complex*>();
  check_cast_array_3d<boost::multi_array<std::complex<double>, 3> const, fftw_complex const*>();

  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<double>, 3>, fftw_complex*>();
  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<double>, 3> const, fftw_complex const*>();
}
...
BOOST_AUTO_TEST_CASE(fftw_cast_array_3d_complex_long_double) {
  check_cast_array_3d<boost::multi_array<std::complex<long double>, 3>, fftwl_complex*>();
  check_cast_array_3d<boost::multi_array<std::complex<long double>, 3> const, fftwl_complex const*>();

  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<long double>, 3>, fftwl_complex*>();
  check_cast_array_3d<jb::fftw::aligned_multi_array<std::complex<long double>, 3> const, fftwl_complex const*>();
}
