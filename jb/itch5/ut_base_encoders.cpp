...
BOOST_AUTO_TEST_CASE(decode_uint16) {
  ...
  auto actual = encoder<true,std::uint16_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, 10 * 256 + 20);

  actual = encoder<false,std::uint16_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, 10 * 256 + 20);

  BOOST_CHECK_NO_THROW((encoder<true,std::uint16_t>::r(16, buffer, 0)));
  BOOST_CHECK_NO_THROW((encoder<true,std::uint16_t>::r(16, buffer, 8)));
  BOOST_CHECK_NO_THROW((encoder<true,std::uint16_t>::r(16, buffer, 14)));
  BOOST_CHECK_THROW(
      (encoder<true,std::uint16_t>::r(16, buffer, 15)), std::runtime_error);
  BOOST_CHECK_NO_THROW((encoder<false,std::uint16_t>::r(16, buffer, 15)));
}
...
BOOST_AUTO_TEST_CASE(decode_uint32) {
  ...
  auto actual = encoder<true,std::uint32_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, ((10 * 256 + 20) * 256 + 30) * 256 + 40);

  actual = encoder<false,std::uint32_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, ((10 * 256 + 20) * 256 + 30) * 256 + 40);

  BOOST_CHECK_NO_THROW((encoder<true,std::uint32_t>::r(16, buffer, 0)));
  BOOST_CHECK_NO_THROW((encoder<true,std::uint32_t>::r(16, buffer, 8)));
  BOOST_CHECK_NO_THROW((encoder<true,std::uint32_t>::r(16, buffer, 12)));
  BOOST_CHECK_THROW(
      (encoder<true,std::uint32_t>::r(16, buffer, 13)), std::runtime_error);
  BOOST_CHECK_NO_THROW((encoder<false,std::uint32_t>::r(16, buffer, 13)));
}
...
BOOST_AUTO_TEST_CASE(decode_uint64) {
  ...
  auto actual = encoder<true,std::uint64_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, expected);

  actual = encoder<false,std::uint64_t>::r(16, buffer, 0);
  BOOST_CHECK_EQUAL(actual, expected);

  BOOST_CHECK_NO_THROW((encoder<true,std::uint64_t>::r(16, buffer, 2)));
  BOOST_CHECK_NO_THROW((encoder<true,std::uint64_t>::r(16, buffer, 7)));
  BOOST_CHECK_THROW(
      (encoder<true,std::uint64_t>::r(16, buffer, 9)), std::runtime_error);
  BOOST_CHECK_NO_THROW((encoder<false,std::uint64_t>::r(16, buffer, 9)));
}
#endif
