...
template <bool validate> struct decoder<validate, std::uint8_t> {
...
template <bool validate> struct decoder<validate, std::uint16_t> {
  /// Please see the generic documentation for jb::itch5::decoder<>::r()
  static std::uint16_t r(std::size_t size, void const* msg,
                         std::size_t offset) {
...
template <bool validate> struct decoder<validate, std::uint32_t> {
  /// Please see the generic documentation for jb::itch5::decoder<>::r()
  static std::uint32_t r(std::size_t size, void const* msg,
                         std::size_t offset) {
...
/// Specialize jb::itch5::decoder for 4-byte integer fields.
template <bool validate> struct decoder<validate, std::uint64_t> {
  /// Please see the generic documentation for jb::itch5::decoder<>::r()
  static std::uint64_t r(std::size_t size, void const* msg,
                         std::size_t offset) {
