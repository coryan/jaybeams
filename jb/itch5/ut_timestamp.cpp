...
BOOST_AUTO_TEST_CASE(decode_timestamp_range) {
  ...
  BOOST_CHECK_NO_THROW(
      (decoder<false,timestamp>::r(16, buffer, 0)));
}
...
BOOST_AUTO_TEST_CASE(stream_timestamp) {
  ...
  {  
    auto nn = (duration_cast<nanoseconds>(hours(7))
               ...
               + duration_cast<nanoseconds>(seconds(9))
               + nanoseconds(20));
...

  {
    auto nn = (duration_cast<nanoseconds>(hours(9))
               ...
               + duration_cast<nanoseconds>(seconds(0))
               + nanoseconds(0));
    std::ostringstream os;
    os << timestamp{nn};
  ...
  {
    auto nn = (duration_cast<nanoseconds>(hours(15))
               + duration_cast<nanoseconds>(minutes(59))
               + duration_cast<nanoseconds>(seconds(59))
