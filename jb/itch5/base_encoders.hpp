...
struct encoder<validate, std::uint8_t> {
  static void
  w(std::size_t size, void* msg, std::size_t offset, std::uint8_t x) {
...
struct encoder<validate, std::uint16_t> {
  ...
  static void
  w(std::size_t size, void* msg, std::size_t offset, std::uint16_t x) {
    ...
    encoder<false, std::uint8_t>::w(
        size, msg, offset + 1, std::uint8_t(x & 0xff));
  }
};
...
struct encoder<validate, std::uint32_t> {
  /// Please see the generic documentation for jb::itch5::encoder<>::w()
  static void
  w(std::size_t size, void* msg, std::size_t offset, std::uint32_t x) {
    ...
    encoder<false, std::uint16_t>::w(
        size, msg, offset + 2, std::uint16_t(x & 0xffff));
  }
};
...
struct encoder<validate, std::uint64_t> {
  /// Please see the generic documentation for jb::itch5::encoder<>::w()
  static void
  w(std::size_t size, void* msg, std::size_t offset, std::uint64_t x) {
